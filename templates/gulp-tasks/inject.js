...
gulp.task('injectPartial', function () {
    return gulp.src(["./pages/*/*.html", "./admin_dashboard.html"], {
            base: "./"
        })
        .pipe(injectPartials())
        .pipe(gulp.dest("."));
...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('./pages/**/*.html', {
        ...
        .pipe(replace('href="admin_dashboard.html"', 'href="../../admin_dashboard.html"'))
        .pipe(gulp.dest('.'));
    var replacePath2 = gulp.src('./**/admin_dashboard.html', {
            base: "./"
        })
        .pipe(replace('href="documentation"', 'href="http://www.bootstrapdash.com/demo/corona-free/jquery/documentation/documentation.html"'))
        .pipe(gulp.dest('.'));
